...
SMODS.Joker{ --Carbuncle
    ...
    loc_txt = {
        ['name'] = 'Carbuncle',
        ['text'] = {
            [1] = '{C:green}#7# in #8# {}chance for {C:red}+#1# {}Mult',
            [2] = '{C:green}#7# in #8# {}chance for {C:blue}+#2# {}Chips',
            [3] = '{C:green}#7# in #8# {}chance to earn {C:money}$#3# {}',
            [4] = 'Each trigger increases their',
            [5] = 'value by {C:red}+#4#{}/{C:blue}+#5#{}/{C:money}$#6#{} respectively'
        },
        ['unlock'] = {
    ...
    loc_vars = function(self, info_queue, card)
        ...
        return {vars = {card.ability.extra.CarbuncleMult, card.ability.extra.CarbuncleChips, card.ability.extra.CarbuncleMoney, card.ability.extra.CarbyMultIncrease, card.ability.extra.CarbyChipIncrease, card.ability.extra.CarbyMoneyIncrease, new_numerator, new_denominator, new_numerator2, new_denominator2, new_numerator3, new_denominator3}}
    end,
        ...
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_5acbe18a', 1, card.ability.extra.odds, 'j_puyotro_carbuncle', false) then
                    ...
                    card.ability.extra.CarbuncleMult = (card.ability.extra.CarbuncleMult) + card.ability.extra.CarbyMultIncrease
                ...
                if SMODS.pseudorandom_probability(card, 'group_1_b7a3e2fb', 1, card.ability.extra.odds, 'j_puyotro_carbuncle', false) then
                    ...
                    card.ability.extra.CarbuncleChips = (card.ability.extra.CarbuncleChips) + card.ability.extra.CarbyChipIncrease
                ...
                if SMODS.pseudorandom_probability(card, 'group_2_391c3d93', 1, card.ability.extra.odds, 'j_puyotro_carbuncle', false) then
                    ...
                    card.ability.extra.CarbuncleMoney = (card.ability.extra.CarbuncleMoney) + card.ability.extra.CarbyMoneyIncrease
